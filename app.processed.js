...
/***/ (function(module, exports) {
	...
	var API_KEY = "6972499059cc79a2ee53c65801a058eb";
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                ...
	                _context.next = 5;
	                return fetch("https://api.openweathermap.org/data/2.5/weather?q=" + city + "," + country + "&units=imperial&appid=" + API_KEY);
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement("input", { type: "text", placeholder: "enter city", name: "city", className: "form-control" }),
	              React.createElement("br", null),
	              React.createElement("input", { type: "text", placeholder: "enter country", name: "country", className: "form-control" }),
	              React.createElement("br", null),
	              React.createElement(
	                "button",
	            ...
	            this.state.image != '' ? React.createElement("img", { src: "http://openweathermap.org/img/w/" + this.state.image + ".png", width: "100px", height: "100px" }) : '',
	            this.state.location != '' ? React.createElement(
	              "h1",
	              null,
	              this.state.location
	            ) : '',
	            this.state.temp != '' ? React.createElement(
	              "h1",
	              null,
	              "Temp: ",
	              this.state.temp,
	            ...
	            this.state.humidity != '' ? React.createElement(
	              "h1",
	              null,
	              "Humidity: ",
	              this.state.humidity,
	            ...
	            this.state.wind != '' ? React.createElement(
	              "h1",
	              null,
	              "Wind Speed: ",
	              this.state.wind,
